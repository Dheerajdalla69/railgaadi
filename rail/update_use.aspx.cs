...
public partial class update_use : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
             if(TextBox2.Text!="" && TextBox3.Text!="" && TextBox4.Text!="")
            {
                if (TextBox3.Text.Equals(TextBox4.Text))
                {
                    ...
                    {
                        con.Open();
                        SqlCommand rs1 = new SqlCommand("update login set password='" + TextBox3.Text + "'  where user_name like '" + TextBox2.Text + "'", con);
                        rs1.ExecuteNonQuery();
